...
2. ALGO SELECTION: Choose execution algorithm (market, limit, time spreading, volume spreading)
...
- **time spreading**: Time-weighted, for large orders
- **volume spreading**: Volume-weighted, minimize market impact
