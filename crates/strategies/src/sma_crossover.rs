...
/// Simple Moving Averages (SMA) of different periods.
...
impl Strategy for SmaCrossover {
    ...
    async fn generate_signals(&self, data: &DataFrame) -> Result<Vec<Signal>> {
        ...
        let short_sma_f64 = short_sma_series.f64()?;
        let long_sma_f64 = long_sma_series.f64()?;
        ...
        for i in 1..data.height() {
            let curr_short = short_sma_f64.get(i);
            let prev_short = short_sma_f64.get(i - 1);
            let curr_long = long_sma_f64.get(i);
            ...
            if let (
                ...
                if in_long && price <= stop_loss {
                    signals.push(Signal {
                        ...
                        stop_loss: None,
                        take_profit: None,
                        reason: "SMA Crossover Stop Loss Hit".to_string(),
