...
mod tests {
    ...
    fn create_test_data() -> DataFrame {
        ...
        let lows = vec![5.0, 6.0, 7.0, 8.0, 9.0, 8.0, 7.0, 6.0, 5.0, 4.0];
        let closes = vec![8.0, 9.0, 10.0, 11.0, 12.0, 11.0, 10.0, 9.0, 8.0, 7.0];
        let timestamps = vec![1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000];
