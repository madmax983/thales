...
pub struct TradeIntent {
    ...
    /// The execution algorithm to use (e.g., "Market", "Limit", "TWAP (Time Weighted Average Price)", "VWAP (Volume Weighted Average Price)").
    #[serde(default)]
...
/// A single candlestick bar representing OHLCV (Open, High, Low, Close, Volume).
///
/// # Examples
///
/// ```rust
...
///     patterns: vec!["Double Bottom".to_string()],
///     key_levels: vec![145.0, 150.0],
...
///
/// let order = Order {
///     id: "OXXXXX-XXXXX-XXXXXX".to_string(),
///     symbol: "AAPL".to_string(),
///     qty: 100.0,
///     filled_qty: 50.0,
///     side: "buy".to_string(),
///     order_type: "limit".to_string(),
///     status: "partial_fill".to_string(),
///     submitted_at_unix_ms: 1622505600000,
///     average_fill_price: Some(150.0),
/// };
///
/// assert_eq!(order.status, "partial_fill");
/// ```
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Order {
    /// The unique order ID.
