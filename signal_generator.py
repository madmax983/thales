...
def main():
    ...
    active_strategies = ["BollingerBands", "RsiMeanReversion", "Macd", "Supertrend", "DonchianBreakout", "StochasticOscillator", "HmaMacdTrend", "VolumeSurgeReversal", "UlcerIndexMeanReversion", "KamaRsiTrend", "KdjStrategy", "NviTrend"]
