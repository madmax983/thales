...
**Rationale:** Used as an alternative to simple or exponential moving averages for trend identification and crossover signals, providing a faster response to price changes than EMA.
...
- The first `period * 2` values will be null.
