...
```json
{
  ...
  "news_summary": "Search failed",
  "recommendation": "Neutral / Wait",
  "confidence": 0.7999999999999999,
  "timestamp_unix_ms": 1772068943404
}
```
...
```json
{
  ...
  "recommendation": "Neutral / Wait",
  "confidence": 0.7999999999999999,
  "timestamp_unix_ms": 1772068958478
}
```
...
```json
{
  ...
  "recommendation": "Neutral / Wait",
  "confidence": 0.7999999999999999,
  "timestamp_unix_ms": 1772068973368
}
```
