...
- Signal type and strength (0-100%): Entry (64.0%)
- Suggested size (quantity): 0.03785
- Stop loss and take profit levels: SL: 56825.0117, TP: 63048.2445
...
- Stop loss and take profit levels: SL: 57937.3802, TP: 63210.8916
...
- Signal type and strength (0-100%): Entry (64.0%)
- Suggested size (quantity): 0.36234
- Stop loss and take profit levels: SL: 3627.1234, TP: 3000.7162
...
- Signal type and strength (0-100%): Entry (64.0%)
- Suggested size (quantity): 2.174042
- Stop loss and take profit levels: SL: 604.5206, TP: 500.1194
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775820589643
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775820589668
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775820589697
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775824142739
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775824142758
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775824142775
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775824729042
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775824729057
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775824729071
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775840135373
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775840135391
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775910326119
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775910326137
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775910326153
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775997718075
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775997718091
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1775997718107
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1776083662275
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1776083662311
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1776083662330
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1776170439561
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1776170439577
}
```
...
```json
{
  ...
  "recommendation": "Consider trend-following strategies (e.g., Moving Average Crossover).",
  "confidence": 0.8,
  "timestamp_unix_ms": 1776170439592
}
```
